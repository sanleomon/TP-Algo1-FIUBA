...
int col;
  ...
  * Post condiciones: Devuelve el vector de coordenadas de las paredes cargado , junto a su respectivo
     tope, las pos inicial del jugador.
*/
void obtener_paredes(int nivel , coordenada_t paredes[MAX_PAREDES], int* tope_paredes , coordenada_t*
pos_inicial_jugador);
